...
#pragma comment(lib, "VC/libcrypto32MT.lib") // OpenSSL v1.0.2: libeay32.lib
#pragma comment(lib, "VC/libssl32MT.lib")    // OpenSSL v1.0.2: ssleay32.lib
#endif
...
std::string ECSmtp::GetErrorText() const
{
	...
	default:
		return "Undefined error id (" + std::to_string(static_cast<int>(ErrorCode)) + ")";
	}
}
